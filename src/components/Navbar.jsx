...
const Navbar = () => {
  ...
  return (
    <>
      {/* Desktop Menu */}
      <div className="hidden fixed left-0 top-0 z-40 lg:flex text-sm bg-primary text-white w-full  pt-4 pb-3 gap-14">
        <div className="wrapper-wide mx-auto flex w-full items-center justify-between ">
